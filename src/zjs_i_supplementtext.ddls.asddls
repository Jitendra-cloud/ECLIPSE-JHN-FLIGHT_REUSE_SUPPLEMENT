...
define view entity ZJS_I_SUPPLEMENTTEXT
  as select from zjs_suppl_text as SupplementText

  association        to parent ZJS_I_SUPPLEMENT as _Supplement on $projection.SupplementID = _Supplement.SupplementID
