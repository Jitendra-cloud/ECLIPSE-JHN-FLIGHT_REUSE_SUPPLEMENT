...
define root view entity ZJS_I_SUPPLEMENT
  as select from zjs_supplement as supplement

  composition [0..*] of ZJS_I_SUPPLEMENTTEXT        as _SupplementText
  association [0..1] to I_Currency                   as _Currency           on $projection.CurrencyCode = _Currency.Currency
  association [0..1] to ZJS_I_SUPPLEMENTCATEGORY_VH as _SupplementCategory on $projection.SupplementCategory = _SupplementCategory.SupplementCategory
